...
subprocess.call('./adb shell uiautomator runtest UITests.jar -c com.ShowNotificationsTest#testExistingContactListAlfaios', shell = True)

device.drag((10,10),(1000,1000),0.15,4)

subprocess.call('./adb shell uiautomator runtest UITests.jar -c com.ShowNotificationsTest#testExistingContactListSinesios', shell = True)

device.drag((10,10),(1000,1000),0.15,4)

subprocess.call('./adb shell uiautomator runtest UITests.jar -c com.ShowNotificationsTest#testExistingContactListAleksandros', shell = True)

device.drag((10,10),(1000,1000),0.15,4)

subprocess.call('./adb shell uiautomator runtest UITests.jar -c com.ShowNotificationsTest#testExistingContactListElenh', shell = True)

device.drag((10,10),(1000,1000),0.15,4)

subprocess.call('./adb shell uiautomator runtest UITests.jar -c com.ShowNotificationsTest#testExistingContactListStefanos', shell = True)
