...
public class RSSItemTest extends InstrumentationTestCase 
{
	...
	public void testGenerateArrayListNamesNocelebration()
	{
		...
		testItem.setLink("eortologio.gr");
		testItem.setTitle("today 13/5 : No widely Nameday today (source : www.namedays.gr)");
		testItem.generateArrayListNames();
		
		actual = testItem.getNames();
		
		String expected = "No widely Nameday today";
		expectedNames.add(expected);
	...
	public void testGenerateArrayListNamesNoDate()
	{
		String[] actual=null;
		
		testItem.setLink("eortologio.gr");
		testItem.setTitle(": Glykeria (source : www.namedays.gr)");
		testItem.generateArrayListNames();
