...
public class RecallLastCommunicationTest extends UiAutomatorTestCase {
...
public void testUniqueMomentExists() throws UiObjectNotFoundException {
    ...
    public void testShowingContactsExists() throws UiObjectNotFoundException { 
...
public void testEmailExists() throws UiObjectNotFoundException
	...
	public void testshowOnClickMenuClear() throws UiObjectNotFoundException { 
		
	getUiDevice().pressDelete();	
	
	UiObject BackfromshowOnClickMenuValidation = new UiObject(new UiSelector().text("Welcome to your Contacts!"));
	...
	public void testeshowOnClickMenuHome() throws UiObjectNotFoundException {
		UiObject showOnClickMenu = new UiObject(new UiSelector().text("showOnClickMenu"));
		showOnClickMenu.click();
		
		getUiDevice().pressHome();	
		
		UiObject HomefromshowOnClickMenuValidation = new UiObject(new UiSelector().packageName("com.android.launcher"));
		assertTrue(HomefromshowOnClickMenuValidation.exists());
